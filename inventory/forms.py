...
from django import forms
from .models import Medicine, StockMovement, Category, Supplier
...
# MedicineForm existe déjà, pas besoin de le modifier
# StockUpdateForm existe déjà, pas besoin de le modifier
